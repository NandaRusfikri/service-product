...
func (c *serviceProductHandlerService) DeleteProductRPC(ctx context.Context, in *DeleteProductRequest, opts ...client.CallOption) (*emptypb.Empty, error) {
...
func (h *serviceProductHandlerHandler) DeleteProductRPC(ctx context.Context, in *DeleteProductRequest, out *emptypb.Empty) error {
